    ...
    _this.onClick = function (node, waveColor) {
      ...
      if (
        ...
        var nodeRoot =
          ...
          node.ownerDocument;
        var nodeBody =
          (_b = getValidateContainer(nodeRoot)) !== null && _b !== void 0 ? _b : nodeRoot;
        styleForPseudo = updateCSS(
          '\n      ['
            .concat(getPrefixCls(''), "-click-animating-without-extra-node='true']::after, .")
            .concat(getPrefixCls(''), '-click-animating-node {\n        --antd-wave-shadow-color: ')
            .concat(waveColor, ';\n      }'),
          'antd-wave',
          {
            csp: _this.csp,
