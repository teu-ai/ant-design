...
var InternalAvatar = function InternalAvatar(props, ref) {
  ...
  var needResponsive = Object.keys(_typeof(size) === 'object' ? size || {} : {}).some(function (
    key,
  ) {
  ...
  var sizeCls = classNames(
    ((_classNames = {}),
    _defineProperty(_classNames, ''.concat(prefixCls, '-lg'), size === 'large'),
    _defineProperty(_classNames, ''.concat(prefixCls, '-sm'), size === 'small'),
    _classNames),
  );
  ...
  var classString = classNames(
    ...
    sizeCls,
    ((_classNames2 = {}),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-').concat(shape), !!shape),
    _defineProperty(
      _classNames2,
      ''.concat(prefixCls, '-image'),
      hasImageElement || (src && isImgExist),
    ),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-icon'), !!icon),
    _classNames2),
    className,
  );
  var sizeStyle =
