...
var Badge = function Badge(_a) {
  ...
  // >>> Display Component
  var displayNode =
    !livingCount || _typeof(livingCount) !== 'object'
      ? undefined
      : cloneElement(livingCount, function (oriProps) {
          return {
  ...
  var statusCls = classNames(
    ((_classNames = {}),
    _defineProperty(_classNames, ''.concat(prefixCls, '-status-dot'), hasStatus),
    _defineProperty(_classNames, ''.concat(prefixCls, '-status-').concat(status), !!status),
    _defineProperty(
      _classNames,
  ...
  var badgeClassName = classNames(
    prefixCls,
    ((_classNames2 = {}),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-status'), hasStatus),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-not-a-wrapper'), !children),
    ...
    /*#__PURE__*/ React.createElement(
      ...
      function (_ref) {
        ...
        var scrollNumberCls = classNames(
          ((_classNames3 = {}),
          _defineProperty(_classNames3, ''.concat(prefixCls, '-dot'), isDot),
          _defineProperty(_classNames3, ''.concat(prefixCls, '-count'), !isDot),
          _defineProperty(_classNames3, ''.concat(prefixCls, '-count-sm'), size === 'small'),
          _defineProperty(
            _classNames3,
            ''.concat(prefixCls, '-multiple-words'),
            !isDot && displayCount && displayCount.toString().length > 1,
          ),
          _defineProperty(_classNames3, ''.concat(prefixCls, '-status-').concat(status), !!status),
          _defineProperty(
            _classNames3,
            ''.concat(prefixCls, '-status-').concat(color),
            isPresetColor(color),
