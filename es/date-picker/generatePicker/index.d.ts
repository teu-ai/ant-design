...
export declare function getTimeProps<DateType, DisabledTime>(
  props: {
    format?: string;
    picker?: PickerMode;
...
declare function generatePicker<DateType>(
...
): import('./interface').PickerComponentClass<
  ...
  unknown
> & {
  WeekPicker: import('./interface').PickerComponentClass<
    Omit<
      PickerProps<DateType> & {
        status?: '' | 'warning' | 'error' | undefined;
        dropdownClassName?: string | undefined;
    ...
    unknown
  >;
  MonthPicker: import('./interface').PickerComponentClass<
    Omit<
      PickerProps<DateType> & {
        status?: '' | 'warning' | 'error' | undefined;
        dropdownClassName?: string | undefined;
    ...
    unknown
  >;
  YearPicker: import('./interface').PickerComponentClass<
    Omit<
      PickerProps<DateType> & {
        status?: '' | 'warning' | 'error' | undefined;
        dropdownClassName?: string | undefined;
    ...
    unknown
  >;
  RangePicker: import('./interface').PickerComponentClass<
    ...
    unknown
  >;
  TimePicker: import('./interface').PickerComponentClass<
    Omit<
      Omit<
    ...
    unknown
  >;
  QuarterPicker: import('./interface').PickerComponentClass<
    Omit<
      Omit<
        RCPickerTimeProps<DateType>,
        'locale' | 'generateConfig' | 'hideHeader' | 'components'
