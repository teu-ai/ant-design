...
export default function ItemHolder(props) {
  ...
  var itemClassName =
    ((_itemClassName = {}),
    _defineProperty(_itemClassName, itemPrefixCls, true),
    _defineProperty(
      _itemClassName,
      ''.concat(itemPrefixCls, '-with-help'),
      hasHelp || debounceErrors.length || debounceWarnings.length,
    ),
    _defineProperty(_itemClassName, ''.concat(className), !!className),
    _defineProperty(
      _itemClassName,
    ...
    _defineProperty(_itemClassName, ''.concat(itemPrefixCls, '-hidden'), hidden),
    _itemClassName);
