...
var Input = /*#__PURE__*/ forwardRef(function (props, ref) {
  ...
  var suffixNode =
    (hasFeedback || suffix) &&
    /*#__PURE__*/ React.createElement(React.Fragment, null, suffix, hasFeedback && feedbackIcon);
  // Allow clear
  var mergedAllowClear;
  if (
    _typeof(allowClear) === 'object' &&
    (allowClear === null || allowClear === void 0 ? void 0 : allowClear.clearIcon)
  ) {
    ...
    _extends(
      ...
      rest,
      {
        ...
        inputClassName: classNames(
          ((_classNames = {}),
          _defineProperty(_classNames, ''.concat(prefixCls, '-sm'), mergedSize === 'small'),
          _defineProperty(_classNames, ''.concat(prefixCls, '-lg'), mergedSize === 'large'),
        ...
        wrapperClassName: classNames(
          _defineProperty({}, ''.concat(prefixCls, '-group-rtl'), direction === 'rtl'),
        ),
