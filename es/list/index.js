...
function List(_a) {
  ...
  var classString = classNames(
    prefixCls,
    ((_classNames = {}),
    _defineProperty(_classNames, ''.concat(prefixCls, '-vertical'), itemLayout === 'vertical'),
    _defineProperty(_classNames, ''.concat(prefixCls, '-').concat(sizeCls), sizeCls),
    _defineProperty(_classNames, ''.concat(prefixCls, '-split'), split),
    _defineProperty(_classNames, ''.concat(prefixCls, '-bordered'), bordered),
    _defineProperty(_classNames, ''.concat(prefixCls, '-loading'), isLoading),
    _defineProperty(_classNames, ''.concat(prefixCls, '-grid'), !!grid),
    _defineProperty(
      _classNames,
  ...
  var paginationProps = _extends(
    _extends(_extends({}, defaultPaginationProps), {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(Spin, _extends({}, loadingProp), childrenContent, children),
      footer &&
        /*#__PURE__*/ React.createElement(
          'div',
          {
