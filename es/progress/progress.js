...
var Progress = function Progress(props) {
  ...
  var classString = classNames(
    ...
    _defineProperty(_classNames, ''.concat(prefixCls, '-status-').concat(progressStatus), true),
    _defineProperty(_classNames, ''.concat(prefixCls, '-show-info'), showInfo),
    _defineProperty(_classNames, ''.concat(prefixCls, '-').concat(size), size),
