...
var Compact = function Compact(props) {
  ...
  var clx = classNames(
    prefixCls,
    ((_classNames2 = {}),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-rtl'), directionConfig === 'rtl'),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-block'), block),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-vertical'), direction === 'vertical'),
    _classNames2),
    className,
  );
  var compactItemContext = React.useContext(SpaceCompactItemContext);
