...
var Steps = function Steps(props) {
  ...
  var getDirection = React.useCallback(
    function () {
  ...
  var stepsClassName = classNames(
    ((_classNames = {}),
    _defineProperty(_classNames, ''.concat(prefixCls, '-rtl'), rtlDirection === 'rtl'),
    _defineProperty(_classNames, ''.concat(prefixCls, '-with-progress'), percent !== undefined),
    _classNames),
    className,
  );
  var icons = {
