...
function InternalTable(props, ref) {
  ...
  var wrapperClassNames = classNames(
    ...
    _defineProperty({}, ''.concat(prefixCls, '-wrapper-rtl'), direction === 'rtl'),
    className,
  );
  return /*#__PURE__*/ React.createElement(
    'div',
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        _extends({}, tableProps, {
          ...
          className: classNames(
            ((_classNames3 = {}),
            _defineProperty(_classNames3, ''.concat(prefixCls, '-middle'), mergedSize === 'middle'),
            _defineProperty(_classNames3, ''.concat(prefixCls, '-small'), mergedSize === 'small'),
            _defineProperty(_classNames3, ''.concat(prefixCls, '-bordered'), bordered),
            _defineProperty(_classNames3, ''.concat(prefixCls, '-empty'), rawData.length === 0),
            _classNames3),
          ),
          data: pageData,
          rowKey: getRowKey,
