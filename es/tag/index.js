...
var InternalTag = function InternalTag(_a, ref) {
  ...
  var tagClassName = classNames(
    prefixCls,
    ((_classNames = {}),
    _defineProperty(_classNames, ''.concat(prefixCls, '-').concat(color), presetColor),
    _defineProperty(_classNames, ''.concat(prefixCls, '-has-color'), color && !presetColor),
    _defineProperty(_classNames, ''.concat(prefixCls, '-hidden'), !visible),
