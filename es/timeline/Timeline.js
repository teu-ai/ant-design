...
var Timeline = function Timeline(props) {
  ...
  var hasLabelItem = timeLineItems.some(function (item) {
    var _a;
    return !!((_a = item === null || item === void 0 ? void 0 : item.props) === null ||
    _a === void 0
      ? void 0
      : _a.label);
  });
  var classString = classNames(
    prefixCls,
    ((_classNames = {}),
    _defineProperty(_classNames, ''.concat(prefixCls, '-pending'), !!pending),
    _defineProperty(_classNames, ''.concat(prefixCls, '-reverse'), !!reverse),
    _defineProperty(_classNames, ''.concat(prefixCls, '-').concat(mode), !!mode && !hasLabelItem),
    _defineProperty(_classNames, ''.concat(prefixCls, '-label'), hasLabelItem),
