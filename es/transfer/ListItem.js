...
var ListItem = function ListItem(props) {
  ...
  var className = classNames(
    ((_classNames = {}),
    _defineProperty(_classNames, ''.concat(prefixCls, '-content-item'), true),
    _defineProperty(
      _classNames,
      ''.concat(prefixCls, '-content-item-disabled'),
      disabled || item.disabled,
    ),
    _defineProperty(_classNames, ''.concat(prefixCls, '-content-item-checked'), checked),
    _classNames),
  );
  var title;
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    function (contextLocale) {
      ...
      var labelNode = /*#__PURE__*/ React.createElement(
        'span',
        {
