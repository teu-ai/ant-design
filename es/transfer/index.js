...
var Transfer = /*#__PURE__*/ (function (_React$Component) {
  ...
  function Transfer(props) {
    ...
    _this.getLocale = function (transferLocale, renderEmpty) {
      ...
      return _extends(
        _extends(_extends({}, transferLocale), {
      ...
      _this.setStateKeys(direction, function (prevKeys) {
        ...
        if (checkAll) {
          ...
          mergedCheckedKeys = Array.from(
            new Set([].concat(_toConsumableArray(prevKeys), _toConsumableArray(selectedKeys))),
          );
        } else {
    ...
    _this.onItemSelect = function (direction, selectedKey, checked) {
      ...
      var holder =
        direction === 'left'
          ? _toConsumableArray(sourceSelectedKeys)
          : _toConsumableArray(targetSelectedKeys);
