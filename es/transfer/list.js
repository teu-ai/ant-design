    ...
    },
    {
      ...
      value: function getListBody(
        ...
        var _this$renderListBody = this.renderListBody(
            renderList,
            _extends(_extends({}, omit(this.props, OmitProps)), {
              filteredItems: filteredItems,
              filteredRenderItems: filteredRenderItems,
        ...
        if (customize) {
          bodyNode = /*#__PURE__*/ React.createElement(
            'div',
            {
        ...
        return /*#__PURE__*/ React.createElement(
          'div',
          {
            className: classNames(
              showSearch
                ? ''.concat(prefixCls, '-body ').concat(prefixCls, '-body-with-search')
    ...
    },
    {
      ...
      value: function render() {
        ...
        var listCls = classNames(
          prefixCls,
          ((_classNames = {}),
          _defineProperty(_classNames, ''.concat(prefixCls, '-with-pagination'), !!pagination),
          _defineProperty(_classNames, ''.concat(prefixCls, '-with-footer'), !!footerDom),
          _classNames),
        );
              ...
              ? {
                  ...
                  onClick: function onClick() {
                    ...
                    var pageKeys = getEnabledItemKeys(
                      (
                        ((_a = _this4.defaultListBodyRef.current) === null || _a === void 0
                          ? void 0
                          : _a.getItems()) || []
                      ).map(function (entity) {
                        return entity.item;
        ...
        var dropdown = /*#__PURE__*/ React.createElement(
          Dropdown,
          {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            showSelectAll
              ? /*#__PURE__*/ React.createElement(React.Fragment, null, checkAllCheckbox, dropdown)
              : null,
            /*#__PURE__*/ React.createElement(
              'span',
              {
