...
var Tree = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var customizePrefixCls = props.prefixCls,
    ...
    motion =
      _props$motion === void 0
        ? _extends(_extends({}, collapseMotion), {
            motionAppear: false,
          })
        : _props$motion;
  ...
  var draggableConfig = React.useMemo(
    function () {
      if (!draggable) {
        return false;
      }
      ...
      if (mergedDraggable.icon !== false) {
        mergedDraggable.icon =
          mergedDraggable.icon || /*#__PURE__*/ React.createElement(HolderOutlined, null);
      }
    ...
    _extends(
      ...
      newProps,
      {
        ...
        className: classNames(
          ((_classNames = {}),
          _defineProperty(_classNames, ''.concat(prefixCls, '-icon-hide'), !showIcon),
          _defineProperty(_classNames, ''.concat(prefixCls, '-block-node'), blockNode),
          _defineProperty(_classNames, ''.concat(prefixCls, '-unselectable'), !selectable),
