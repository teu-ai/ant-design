...
var Base = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var needMeasureEllipsis = React.useMemo(
    function () {
      return (
        // Disable ellipsis
  ...
  var onResize = function onResize(_ref2, element) {
    ...
    setEllipsisFontSize(
      parseInt(
        (_a = window.getComputedStyle) === null || _a === void 0
          ? void 0
          : _a.call(window, element).fontSize,
        10,
      ) || 0,
    );
  };
  ...
  React.useEffect(
    function () {
      ...
      if (enableEllipsis && cssEllipsis && textEle) {
        var currentEllipsis = cssLineClamp
  ...
  var topAriaLabel = React.useMemo(
    function () {
  ...
  if (editing) {
    return /*#__PURE__*/ React.createElement(Editable, {
      value:
        (_c = editConfig.text) !== null && _c !== void 0
          ? _c
  ...
  var renderCopy = function renderCopy() {
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        copied
          ? getNode(iconNodes[1], /*#__PURE__*/ React.createElement(CheckOutlined, null), true)
          : getNode(iconNodes[0], /*#__PURE__*/ React.createElement(CopyOutlined, null), true),
      ),
    );
  };
        ...
        /*#__PURE__*/ React.createElement(
          ...
          _extends(
            {
              className: classNames(
                ...
                _defineProperty(_classNames, ''.concat(prefixCls, '-ellipsis'), enableEllipsis),
                _defineProperty(
                  _classNames,
                  ''.concat(prefixCls, '-single-line'),
                  mergedEnableEllipsis && rows === 1,
                ),
                _defineProperty(
                  _classNames,
                ...
                _defineProperty(
                  _classNames,
                  ''.concat(prefixCls, '-ellipsis-multiple-line'),
                  cssLineClamp,
                ),
                _classNames),
                className,
              ...
              'aria-label':
                topAriaLabel === null || topAriaLabel === void 0 ? void 0 : topAriaLabel.toString(),
              title: title,
            },
            textProps,
          ),
          /*#__PURE__*/ React.createElement(
            ...
            function (node, needEllipsis) {
              ...
              var wrappedContext = wrapperDecorations(
                props,
                /*#__PURE__*/ React.createElement(
                  React.Fragment,
                  null,
