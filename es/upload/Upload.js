...
var InternalUpload = function InternalUpload(props, ref) {
  ...
  var handleRemove = function handleRemove(file) {
    var currentFile;
    Promise.resolve(typeof onRemove === 'function' ? onRemove(file) : onRemove).then(function (
      ret,
    ) {
      var _a;
      ...
      if (removedFileList) {
        ...
        mergedFileList === null || mergedFileList === void 0
          ? void 0
          : mergedFileList.forEach(function (item) {
  ...
  if (type === 'drag') {
    var _classNames;
    var dragCls = classNames(
      prefixCls,
      ((_classNames = {}),
      _defineProperty(_classNames, ''.concat(prefixCls, '-drag'), true),
      _defineProperty(
        _classNames,
        ''.concat(prefixCls, '-drag-uploading'),
        mergedFileList.some(function (file) {
          return file.status === 'uploading';
        }),
      ),
      _defineProperty(_classNames, ''.concat(prefixCls, '-drag-hover'), dragState === 'dragover'),
      _defineProperty(_classNames, ''.concat(prefixCls, '-disabled'), mergedDisabled),
  ...
  var uploadButtonCls = classNames(
    prefixCls,
    ((_classNames2 = {}),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-select'), true),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-select-').concat(listType), true),
    _defineProperty(_classNames2, ''.concat(prefixCls, '-disabled'), mergedDisabled),
  ...
  var uploadButton = renderUploadButton(
    children
      ? undefined
      : {
          display: 'none',
