...
var InternalUploadList = function InternalUploadList(props, ref) {
  ...
  var internalIconRender = function internalIconRender(file) {
    ...
    var fileIcon =
      isImgUrl && isImgUrl(file)
        ? /*#__PURE__*/ React.createElement(PictureTwoTone, null)
        : /*#__PURE__*/ React.createElement(FileTwoTone, null);
    var icon = isLoading
      ? /*#__PURE__*/ React.createElement(LoadingOutlined, null)
      : /*#__PURE__*/ React.createElement(PaperClipOutlined, null);
    if (listType === 'picture') {
  ...
  var actionIconRender = function actionIconRender(customIcon, callback, prefixCls, title) {
    ...
    if (isValidElement(customIcon)) {
      var btnIcon = cloneElement(
        customIcon,
        _extends(_extends({}, customIcon.props), {
  ...
  var listClassNames = classNames(
    ((_classNames = {}),
    _defineProperty(_classNames, ''.concat(prefixCls, '-list'), true),
    _defineProperty(_classNames, ''.concat(prefixCls, '-list-').concat(listType), true),
    _defineProperty(_classNames, ''.concat(prefixCls, '-list-rtl'), direction === 'rtl'),
    _classNames),
  );
  // >>> Motion config
  var motionKeyList = _toConsumableArray(
