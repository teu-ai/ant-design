...
var __decorate =
  ...
  function (decorators, target, key, desc) {
    var c = arguments.length,
      ...
      d;
    if (
      (typeof Reflect === 'undefined' ? 'undefined' : (0, _typeof2['default'])(Reflect)) ===
        'object' &&
  ...
  function Affix() {
    ...
    _this.prepareMeasure = function () {
      ...
      if (process.env.NODE_ENV === 'test') {
        ...
        onTestUpdatePosition === null || onTestUpdatePosition === void 0
          ? void 0
  ...
  (0, _createClass2['default'])(Affix, [
    {
      ...
      value: function getTargetFunc() {
        ...
        return getTargetContainer !== null && getTargetContainer !== void 0
          ? getTargetContainer
          : getDefaultTarget;
      },
      // Event handler
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        var targetFunc = this.getTargetFunc();
        var newTarget =
          (targetFunc === null || targetFunc === void 0 ? void 0 : targetFunc()) || null;
      ...
      value: function lazyUpdatePosition() {
        ...
        if (targetFunc && affixStyle) {
          ...
          if (targetNode && this.placeholderNode) {
            ...
            var fixedTop = (0, _utils.getFixedTop)(placeholderReact, targetRect, offsetTop);
            var fixedBottom = (0, _utils.getFixedBottom)(
              placeholderReact,
              targetRect,
              offsetBottom,
            );
    ...
    },
    {
      ...
      value: function render() {
        ...
        var className = (0, _classnames['default'])(
          (0, _defineProperty2['default'])({}, affixPrefixCls, !!affixStyle),
        );
        var props = (0, _omit['default'])(this.props, [
          'prefixCls',
          'offsetTop',
          'offsetBottom',
          'target',
...
var AffixFC = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/ React.createElement(
    Affix,
    (0, _extends2['default'])({}, affixProps, {
      ref: ref,
    }),
  );
});
