...
var _ExclamationCircleOutlined = _interopRequireDefault(
  require('@ant-design/icons/ExclamationCircleOutlined'),
);
...
var IconNode = function IconNode(props) {
  ...
  if (icon) {
    return (0, _reactNode.replaceElement)(
      icon,
      ...
      function () {
        return {
          className: (0, _classnames['default'])(
            ...
            (0, _defineProperty2['default'])({}, icon.props.className, icon.props.className),
          ),
        };
      },
    );
...
var Alert = function Alert(_a) {
  ...
  var alertCls = (0, _classnames['default'])(
    ...
    (0, _defineProperty2['default'])(_classNames2, ''.concat(prefixCls, '-no-icon'), !isShowIcon),
    (0, _defineProperty2['default'])(_classNames2, ''.concat(prefixCls, '-banner'), !!banner),
    (0, _defineProperty2['default'])(
      _classNames2,
