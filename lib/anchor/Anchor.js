...
var AnchorContent = function AnchorContent(props) {
  ...
  var getCurrentContainer =
    (_a = getContainer !== null && getContainer !== void 0 ? getContainer : getTargetContainer) !==
      null && _a !== void 0
      ? _a
      : getDefaultContainer;
  var dependencyListItem = JSON.stringify(links);
  var registerLink = React.useCallback(
    function (link) {
  ...
  var unregisterLink = React.useCallback(
    function (link) {
      if (links.includes(link)) {
        setLinks(function (prev) {
  ...
  var updateInk = function updateInk() {
    var _a;
    var linkNode =
      (_a = wrapperRef.current) === null || _a === void 0
        ? void 0
        : _a.querySelector('.'.concat(prefixCls, '-link-title-active'));
    if (linkNode && spanLinkNode.current) {
      spanLinkNode.current.style.top = ''.concat(
  ...
  var getInternalCurrentAnchor = function getInternalCurrentAnchor(_links) {
    ...
    _links.forEach(function (link) {
      var sharpLinkMatch = sharpMatcherRegx.exec(
        link === null || link === void 0 ? void 0 : link.toString(),
      );
      if (!sharpLinkMatch) {
        return;
      }
  ...
  var handleScroll = React.useCallback(
    function () {
      ...
      var currentActiveLink = getInternalCurrentAnchor(
        links,
  ...
  var handleScrollTo = React.useCallback(
    function (link) {
  ...
  var inkClass = (0, _classnames['default'])(
    (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-ink-ball-visible'), activeLink),
    ''.concat(prefixCls, '-ink-ball'),
  );
  var wrapperClass = (0, _classnames['default'])(
    ''.concat(prefixCls, '-wrapper'),
    (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-rtl'), direction === 'rtl'),
    className,
  );
  var anchorClass = (0, _classnames['default'])(
    prefixCls,
    (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-fixed'), !affix && !showInkInFixed),
  );
  ...
  var anchorContent = /*#__PURE__*/ React.createElement(
    'div',
    {
      ref: wrapperRef,
  ...
  var memoizedContextValue = React.useMemo(
    function () {
      return {
