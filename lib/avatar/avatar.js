...
var InternalAvatar = function InternalAvatar(props, ref) {
  ...
  var needResponsive = Object.keys(
    (0, _typeof2['default'])(size) === 'object' ? size || {} : {},
  ).some(function (key) {
    return ['xs', 'sm', 'md', 'lg', 'xl', 'xxl'].includes(key);
  });
  var screens = (0, _useBreakpoint['default'])(needResponsive);
  var responsiveSizeStyle = React.useMemo(
    function () {
  ...
  var sizeCls = (0, _classnames['default'])(
    ((_classNames = {}),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-lg'), size === 'large'),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-sm'), size === 'small'),
    _classNames),
  );
  ...
  var classString = (0, _classnames['default'])(
    ...
    (0, _defineProperty2['default'])(
      ...
      hasImageElement || (src && isImgExist),
    ),
    (0, _defineProperty2['default'])(_classNames2, ''.concat(prefixCls, '-icon'), !!icon),
    _classNames2),
    className,
  );
  var sizeStyle =
  ...
  if (typeof src === 'string' && isImgExist) {
    ...
    var sizeChildrenStyle =
      typeof size === 'number'
        ...
        : {};
    childrenToRender = /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        'span',
        {
          ...
          style: (0, _extends2['default'])(
            (0, _extends2['default'])({}, sizeChildrenStyle),
            childrenStyle,
          ),
        },
        children,
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    (0, _extends2['default'])({}, others, {
      style: (0, _extends2['default'])(
        (0, _extends2['default'])((0, _extends2['default'])({}, sizeStyle), responsiveSizeStyle),
        others.style,
      ),
