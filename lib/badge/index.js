...
var Badge = function Badge(_a) {
  ...
  // =============================== Styles ===============================
  var mergedStyle = (0, React.useMemo)(
    function () {
      if (!offset) {
  ...
  // >>> Display Component
  var displayNode =
    !livingCount || (0, _typeof2['default'])(livingCount) !== 'object'
      ? undefined
      : (0, _reactNode.cloneElement)(livingCount, function (oriProps) {
          return {
            style: (0, _extends2['default'])(
              (0, _extends2['default'])({}, mergedStyle),
              oriProps.style,
            ),
          };
        });
  ...
  var statusCls = (0, _classnames['default'])(
    ((_classNames = {}),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-status-dot'), hasStatus),
  ...
  var badgeClassName = (0, _classnames['default'])(
    prefixCls,
    ((_classNames2 = {}),
    (0, _defineProperty2['default'])(_classNames2, ''.concat(prefixCls, '-status'), hasStatus),
    (0, _defineProperty2['default'])(
      _classNames2,
    ...
    /*#__PURE__*/ React.createElement(
      ...
      function (_ref) {
        ...
        var scrollNumberCls = (0, _classnames['default'])(
          ((_classNames3 = {}),
          (0, _defineProperty2['default'])(_classNames3, ''.concat(prefixCls, '-dot'), isDot),
          (0, _defineProperty2['default'])(_classNames3, ''.concat(prefixCls, '-count'), !isDot),
          (0, _defineProperty2['default'])(
            _classNames3,
