...
function insertSpace(child, needInserted) {
  ...
  if (typeof child === 'string') {
    return isTwoCNChar(child)
      ? /*#__PURE__*/ React.createElement('span', null, child.split('').join(SPACE))
...
var InternalButton = function InternalButton(props, ref) {
  ...
  var loadingOrDelay =
    typeof loading === 'boolean'
      ? loading
      : (loading === null || loading === void 0 ? void 0 : loading.delay) || true;
  React.useEffect(
    function () {
      var delayTimer = null;
  ...
  var classes = (0, _classnames['default'])(
    ...
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-').concat(type), type),
    (0, _defineProperty2['default'])(
      _classNames,
    ...
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-loading'), innerLoading),
    (0, _defineProperty2['default'])(
      _classNames,
      ''.concat(prefixCls, '-two-chinese-chars'),
      hasTwoCNChar && autoInsertSpace && !innerLoading,
    ),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-block'), block),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-dangerous'), !!danger),
    (0, _defineProperty2['default'])(
      _classNames,
  ...
  if (linkButtonRestProps.href !== undefined) {
    return /*#__PURE__*/ React.createElement(
      'a',
      (0, _extends2['default'])({}, linkButtonRestProps, {
        className: classes,
        onClick: handleClick,
        ref: buttonRef,
      }),
