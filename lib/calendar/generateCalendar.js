...
function generateCalendar(generateConfig) {
  ...
  var Calendar = function Calendar(props) {
    ...
    // Disabled Date
    var mergedDisabledDate = React.useCallback(
      function (date) {
    ...
    var getDefaultLocale = function getDefaultLocale() {
      ...
      var result = (0, _extends2['default'])(
        (0, _extends2['default'])({}, _en_US['default']),
        locale,
      );
      result.lang = (0, _extends2['default'])(
        (0, _extends2['default'])({}, result.lang),
        (locale || {}).lang,
      );
      return result;
    };
    // ====================== Render ======================
    var dateRender = React.useCallback(
      function (date) {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            (0, _padStart['default'])(String(generateConfig.getDate(date)), 2, '0'),
          ),
          /*#__PURE__*/ React.createElement(
            'div',
            {
    ...
    var monthRender = React.useCallback(
