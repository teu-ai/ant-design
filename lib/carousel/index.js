...
var Carousel = /*#__PURE__*/ React.forwardRef(function (_a, ref) {
  ...
  var _a$dots = _a.dots,
    ...
    vertical =
      _a$vertical === void 0 ? dotPosition === 'left' || dotPosition === 'right' : _a$vertical,
  ...
  var enableDots = !!dots;
  var dsClass = (0, _classnames['default'])(
    dotsClass,
    ''.concat(dotsClass, '-').concat(dotPosition),
    typeof dots === 'boolean' ? false : dots === null || dots === void 0 ? void 0 : dots.className,
  );
