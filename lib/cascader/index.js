...
function highlightKeyword(str, lowerKeyword, prefixCls) {
  var cells = str
    ...
    .reduce(function (list, cur, index) {
      return index === 0
        ? [cur]
        : [].concat((0, _toConsumableArray2['default'])(list), [lowerKeyword, cur]);
    }, []);
  var fillCells = [];
  var start = 0;
...
var Cascader = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var mergedDropdownClassName = (0, _classnames['default'])(
    ...
    (0, _defineProperty2['default'])(
      {},
      ''.concat(cascaderPrefixCls, '-dropdown-rtl'),
      mergedDirection === 'rtl',
    ),
  );
  // ==================== Search =====================
  var mergedShowSearch = React.useMemo(
    function () {
      ...
      if ((0, _typeof2['default'])(showSearch) === 'object') {
        searchConfig = (0, _extends2['default'])(
          (0, _extends2['default'])({}, searchConfig),
          showSearch,
        );
      }
      return searchConfig;
  ...
  var _getIcons = (0, _iconUtil['default'])(
    ...
    (0, _extends2['default'])(
      {
        ...
        className: (0, _classnames['default'])(
          ...
          (0, _defineProperty2['default'])(_classNames2, ''.concat(prefixCls, '-rtl'), isRtl),
          (0, _defineProperty2['default'])(
            _classNames2,
      ...
      restProps,
      {
        ...
        choiceTransitionName: (0, _motion.getTransitionName)(
          rootPrefixCls,
          '',
          choiceTransitionName,
        ),
        transitionName: (0, _motion.getTransitionName)(
          rootPrefixCls,
          (0, _motion.getTransitionDirection)(placement),
          transitionName,
        ),
