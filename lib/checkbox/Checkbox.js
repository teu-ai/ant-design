...
var InternalCheckbox = function InternalCheckbox(_a, ref) {
  ...
  var classString = (0, _classnames['default'])(
    ((_classNames = {}),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-wrapper'), true),
    ...
    (0, _defineProperty2['default'])(
      _classNames,
      ''.concat(prefixCls, '-wrapper-checked'),
      checkboxProps.checked,
    ),
    (0, _defineProperty2['default'])(
      _classNames,
      ''.concat(prefixCls, '-wrapper-disabled'),
      mergedDisabled,
    ),
    (0, _defineProperty2['default'])(
      _classNames,
      ''.concat(prefixCls, '-wrapper-in-form-item'),
      isFormItemInput,
    ),
    _classNames),
    className,
  ...
  var checkboxClass = (0, _classnames['default'])(
    (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-indeterminate'), indeterminate),
  );
