...
function generatePicker(generateConfig) {
  function getPicker(picker, displayName) {
    var Picker = /*#__PURE__*/ (0, React.forwardRef)(function (props, ref) {
      ...
      additionalOverrideProps = (0, _extends2['default'])(
        (0, _extends2['default'])(
          (0, _extends2['default'])({}, additionalOverrideProps),
          showTime
            ? (0, _.getTimeProps)(
                (0, _extends2['default'])(
                  {
      ...
      process.env.NODE_ENV !== 'production'
        ? (0, _warning['default'])(
            ...
            displayName,
            'DatePicker.'
              .concat(displayName, " is legacy usage. Please use DatePicker[picker='")
              .concat(picker, "'] directly."),
          )
        : void 0;
      process.env.NODE_ENV !== 'production'
        ? (0, _warning['default'])(
      ...
      var suffixNode = /*#__PURE__*/ React.createElement(
        React.Fragment,
        null,
        mergedPicker === 'time'
          ? /*#__PURE__*/ React.createElement(_ClockCircleOutlined['default'], null)
          : /*#__PURE__*/ React.createElement(_CalendarOutlined['default'], null),
              ...
              additionalOverrideProps,
              {
                ...
                className: (0, _classnames['default'])(
                  ...
                  (0, _statusUtils.getStatusClassNames)(
                    prefixCls,
                    (0, _statusUtils.getMergedStatus)(contextStatus, customStatus),
                    hasFeedback,
                  ),
