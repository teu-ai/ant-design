  ...
  return items.map(function (_ref3, index) {
    ...
    if (typeof component === 'string') {
      return /*#__PURE__*/ React.createElement(_Cell['default'], {
        ...
        className: className,
        style: style,
        labelStyle: (0, _extends2['default'])(
          (0, _extends2['default'])({}, rootLabelStyle),
          labelStyle,
        ),
        contentStyle: (0, _extends2['default'])(
          (0, _extends2['default'])({}, rootContentStyle),
          contentStyle,
        ),
        span: span,
        colon: colon,
    ...
    return [
      /*#__PURE__*/ React.createElement(_Cell['default'], {
        ...
        style: (0, _extends2['default'])(
          (0, _extends2['default'])((0, _extends2['default'])({}, rootLabelStyle), style),
          labelStyle,
        ),
        span: 1,
        colon: colon,
      ...
      /*#__PURE__*/ React.createElement(_Cell['default'], {
        ...
        className: className,
        style: (0, _extends2['default'])(
          (0, _extends2['default'])((0, _extends2['default'])({}, rootContentStyle), style),
          contentStyle,
        ),
        span: span * 2 - 1,
