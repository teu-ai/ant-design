...
function Drawer(props) {
      ...
      'div',
      {
        className: (0, _classnames['default'])(
          ...
          (0, _defineProperty2['default'])(
            {},
            ''.concat(prefixCls, '-header-close-only'),
  ...
  // ============================ Size ============================
  var mergedWidth = React.useMemo(
    function () {
      return width !== null && width !== void 0 ? width : size === 'large' ? 736 : 378;
    },
    [width, size],
  );
  var mergedHeight = React.useMemo(
    function () {
  ...
  var panelMotion = function panelMotion(motionPlacement) {
    return {
      motionName: (0, _motion.getTransitionName)(
        prefixCls,
        'panel-motion-'.concat(motionPlacement),
      ),
      motionAppear: true,
      motionEnter: true,
      motionLeave: true,
        ...
        (0, _extends2['default'])(
          ...
          rest,
          {
            ...
            afterOpenChange: function afterOpenChange(isOpen) {
              _afterOpenChange === null || _afterOpenChange === void 0
                ? void 0
                : _afterOpenChange(isOpen);
              afterVisibleChange === null || afterVisibleChange === void 0
                ? void 0
