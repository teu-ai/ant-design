...
var Dropdown = function Dropdown(props) {
    ...
    if (placement.includes('Center')) {
      ...
      process.env.NODE_ENV !== 'production'
        ? (0, _warning['default'])(
            ...
            'Dropdown',
            "You are using '"
              .concat(placement, "' placement in Dropdown, which is deprecated. Try to use '")
              .concat(newPlacement, "' instead."),
          )
        : void 0;
      return newPlacement;
    }
  ...
  // =========================== Overlay ============================
  var overlayClassNameCustomized = (0, _classnames['default'])(
    overlayClassName,
    (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-rtl'), direction === 'rtl'),
  );
        ...
        validator: function validator(_ref3) {
          ...
          process.env.NODE_ENV !== 'production'
            ? (0, _warning['default'])(
                !mode || mode === 'vertical',
                'Dropdown',
                'mode="'.concat(mode, '" is not supported for Dropdown\'s Menu.'),
              )
            : void 0;
        },
      },
