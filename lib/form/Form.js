...
var InternalForm = function InternalForm(props, ref) {
  ...
  var mergedRequiredMark = (0, React.useMemo)(
    function () {
  ...
  var formClassName = (0, _classnames['default'])(
    prefixCls,
    ((_classNames = {}),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-').concat(layout), true),
  ...
  var formContextValue = (0, React.useMemo)(
    function () {
      return {
        name: name,
