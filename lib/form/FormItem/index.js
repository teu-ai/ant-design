...
var MemoInput = /*#__PURE__*/ React.memo(
  function (_ref) {
  ...
  function (prev, next) {
    return (
      ...
      prev.childProps.every(function (value, index) {
...
function InternalFormItem(props) {
  ...
  var onMetaChange = function onMetaChange(nextMeta) {
    ...
    var keyInfo =
      listContext === null || listContext === void 0 ? void 0 : listContext.getKey(nextMeta.name);
  ...
  var onSubItemMetaChange = function onSubItemMetaChange(subMeta, uniqueKeys) {
    ...
    setSubFieldErrors(function (prevSubFieldErrors) {
      ...
      var mergedNamePath = [].concat(
        (0, _toConsumableArray2['default'])(subMeta.name.slice(0, -1)),
        (0, _toConsumableArray2['default'])(uniqueKeys),
      );
      ...
      function () {
        ...
        Object.values(subFieldErrors).forEach(function (subFieldError) {
          errorList.push.apply(
            errorList,
            (0, _toConsumableArray2['default'])(subFieldError.errors || []),
          );
          warningList.push.apply(
            warningList,
            (0, _toConsumableArray2['default'])(subFieldError.warnings || []),
          );
        });
  ...
  if (messageVariables) {
    variables = (0, _extends2['default'])(
      (0, _extends2['default'])({}, variables),
      messageVariables,
    );
  }
  // >>>>> With Field
    ...
    function (control, renderMeta, context) {
        ...
        required !== undefined
          ...
          : !!(
              ...
              rules.some(function (rule) {
                if (
                  rule &&
                  (0, _typeof2['default'])(rule) === 'object' &&
                  rule.required &&
                  !rule.warningOnly
                ) {
                  return true;
      ...
      if (Array.isArray(children) && hasName) {
        ...
        var childProps = (0, _extends2['default'])(
          (0, _extends2['default'])({}, children.props),
          mergedControl,
        );
        if (!childProps.id) {
        ...
        var triggers = new Set(
          [].concat(
            (0, _toConsumableArray2['default'])((0, _util.toArray)(trigger)),
            (0, _toConsumableArray2['default'])((0, _util.toArray)(mergedValidateTrigger)),
          ),
        );
        triggers.forEach(function (eventName) {
          childProps[eventName] = function () {
            ...
            (_c = (_b = children.props)[eventName]) === null || _c === void 0
              ? void 0
              : (_c2 = _c).call.apply(_c2, [_b].concat(args));
          };
        });
        // List of props that need to be watched for changes -> if changes are detected in MemoInput -> rerender
        var watchingChildProps = [
