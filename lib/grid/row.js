...
var Row = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  React.useEffect(function () {
    var token = _responsiveObserve['default'].subscribe(function (screen) {
      ...
      if (
        (!Array.isArray(currentGutter) && (0, _typeof2['default'])(currentGutter) === 'object') ||
        (Array.isArray(currentGutter) &&
          ((0, _typeof2['default'])(currentGutter[0]) === 'object' ||
            (0, _typeof2['default'])(currentGutter[1]) === 'object'))
      ) {
        setScreens(screen);
      }
    });
  ...
  var classes = (0, _classnames['default'])(
    prefixCls,
    ((_classNames = {}),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-no-wrap'), wrap === false),
    (0, _defineProperty2['default'])(
      _classNames,
      ''.concat(prefixCls, '-').concat(mergeJustify),
      mergeJustify,
    ),
    (0, _defineProperty2['default'])(
      _classNames,
      ''.concat(prefixCls, '-').concat(mergeAlign),
      mergeAlign,
    ),
    (0, _defineProperty2['default'])(
      _classNames,
