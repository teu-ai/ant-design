...
var LocaleReceiver = function LocaleReceiver(props) {
  ...
  var getLocale = React.useMemo(
    function () {
      var _a;
      var locale = defaultLocale || _default2['default'][componentName];
      var localeFromContext =
        (_a = antLocale === null || antLocale === void 0 ? void 0 : antLocale[componentName]) !==
          null && _a !== void 0
          ? _a
          : {};
      return (0, _extends2['default'])(
        (0, _extends2['default'])({}, locale instanceof Function ? locale() : locale),
        localeFromContext || {},
      );
    },
    [componentName, defaultLocale, antLocale],
  );
  var getLocaleCode = React.useMemo(
    function () {
    ...
    function () {
      ...
      var localeFromContext =
        (_a = antLocale === null || antLocale === void 0 ? void 0 : antLocale[componentName]) !==
          ...
          : {};
      return (0, _extends2['default'])(
        (0, _extends2['default'])({}, typeof locale === 'function' ? locale() : locale),
        localeFromContext || {},
      );
    },
    [componentName, defaultLocale, antLocale],
