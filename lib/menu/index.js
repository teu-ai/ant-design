...
var InternalMenu = /*#__PURE__*/ (0, React.forwardRef)(function (props, ref) {
  ...
  process.env.NODE_ENV !== 'production'
    ...
    : void 0;
  (_a = override.validator) === null || _a === void 0
    ? void 0
    : _a.call(override, {
        mode: mode,
      });
  ...
  var onItemClick = (0, _useEvent['default'])(function () {
    ...
    (_a = override === null || override === void 0 ? void 0 : override.onClick) === null ||
    _a === void 0
      ? void 0
      : _a.call(override);
  });
  ...
  // ======================= Selectable ========================
  var mergedSelectable =
    selectable !== null && selectable !== void 0 ? selectable : override.selectable;
  // ======================== Collapsed ========================
  // Inline Collapsed
  var mergedInlineCollapsed = React.useMemo(
    function () {
  ...
  return /*#__PURE__*/ React.createElement(
    _OverrideContext['default'].Provider,
    {
      value: null,
    },
    /*#__PURE__*/ React.createElement(
      _MenuContext['default'].Provider,
      {
        value: contextValue,
      },
      /*#__PURE__*/ React.createElement(
