...
var Modal = function Modal(props) {
  ...
  var defaultFooter = /*#__PURE__*/ React.createElement(
  ...
  var wrapClassNameExtended = (0, _classnames['default'])(
    wrapClassName,
    ((_classNames = {}),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-centered'), !!centered),
  ...
  return /*#__PURE__*/ React.createElement(
    _Compact.NoCompactStyle,
    null,
    /*#__PURE__*/ React.createElement(
      _context.NoFormStyle,
      {
        status: true,
        override: true,
      },
      /*#__PURE__*/ React.createElement(
        ...
        (0, _extends2['default'])(
          ...
          restProps,
          {
            ...
            mousePosition:
              (_a = restProps.mousePosition) !== null && _a !== void 0 ? _a : mousePosition,
            onClose: handleCancel,
            closeIcon: closeIconToRender,
            focusTriggerAfterClose: focusTriggerAfterClose,
            transitionName: (0, _motion.getTransitionName)(
              rootPrefixCls,
              'zoom',
              props.transitionName,
            ),
            maskTransitionName: (0, _motion.getTransitionName)(
              rootPrefixCls,
              'fade',
