...
var renderBreadcrumb = function renderBreadcrumb(breadcrumb) {
  return /*#__PURE__*/ React.createElement(
    _breadcrumb['default'],
    (0, _extends2['default'])({}, breadcrumb),
  );
};
var getBackIcon = function getBackIcon(props) {
  ...
  return direction === 'rtl'
    ? /*#__PURE__*/ React.createElement(_ArrowRightOutlined['default'], null)
    : /*#__PURE__*/ React.createElement(_ArrowLeftOutlined['default'], null);
};
...
var PageHeader = function PageHeader(props) {
  ...
  return /*#__PURE__*/ React.createElement(_configProvider.ConfigConsumer, null, function (_ref2) {
    ...
    var breadcrumbRenderDomFromProps =
      (_a =
        breadcrumbRender === null || breadcrumbRender === void 0
          ? void 0
          : breadcrumbRender(props, defaultBreadcrumbDom)) !== null && _a !== void 0
        ? _a
    ...
    var className = (0, _classnames['default'])(
      ...
      (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-ghost'), ghost),
      (0, _defineProperty2['default'])(
        _classNames,
        ''.concat(prefixCls, '-rtl'),
        direction === 'rtl',
      ),
      (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-compact'), compact),
      _classNames),
    );
    return /*#__PURE__*/ React.createElement(
