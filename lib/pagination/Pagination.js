...
var Pagination = function Pagination(_a) {
  ...
  var mergedShowSizeChanger =
    showSizeChanger !== null && showSizeChanger !== void 0
      ? showSizeChanger
      : pagination.showSizeChanger;
  var getIconsProps = function getIconsProps() {
    var ellipsis = /*#__PURE__*/ React.createElement(
      'span',
      {
    ...
    var prevIcon = /*#__PURE__*/ React.createElement(
      'button',
      {
    ...
    var nextIcon = /*#__PURE__*/ React.createElement(
      'button',
      {
        className: ''.concat(prefixCls, '-item-link'),
        type: 'button',
    ...
    var jumpPrevIcon = /*#__PURE__*/ React.createElement(
      'a',
      {
        className: ''.concat(prefixCls, '-item-link'),
      },
    ...
    var jumpNextIcon = /*#__PURE__*/ React.createElement(
      'a',
      {
        className: ''.concat(prefixCls, '-item-link'),
      },
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    function (contextLocale) {
      var _classNames;
      var locale = (0, _extends2['default'])(
      ...
      var extendedClassName = (0, _classnames['default'])(
        ((_classNames = {}),
        (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-mini'), isSmall),
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        (0, _extends2['default'])({}, getIconsProps(), restProps, {
          prefixCls: prefixCls,
          selectPrefixCls: selectPrefixCls,
          className: extendedClassName,
          selectComponentClass:
            selectComponentClass || (isSmall ? _Select.MiniSelect : _Select.MiddleSelect),
          locale: locale,
