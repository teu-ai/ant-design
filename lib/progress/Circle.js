...
function getPercentage(_ref) {
  ...
  var realSuccessPercent = (0, _utils.validProgress)(
    (0, _utils.getSuccessPercent)({
      success: success,
  ...
  return [
    realSuccessPercent,
    (0, _utils.validProgress)((0, _utils.validProgress)(percent) - realSuccessPercent),
  ];
}
...
var Circle = function Circle(props) {
  ...
  var wrapperClassName = (0, _classnames['default'])(
    ...
    (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-circle-gradient'), isGradient),
  );
