...
var Progress = function Progress(props) {
  ...
  function renderProcessInfo(prefixCls, progressStatus) {
    ...
    if (format || (progressStatus !== 'exception' && progressStatus !== 'success')) {
      text = textFormatter(
        (0, _utils.validProgress)(percent),
        (0, _utils.validProgress)(successPercent),
      );
    } else if (progressStatus === 'exception') {
      text = isLineType
        ? /*#__PURE__*/ React.createElement(_CloseCircleFilled['default'], null)
        : /*#__PURE__*/ React.createElement(_CloseOutlined['default'], null);
    } else if (progressStatus === 'success') {
      text = isLineType
        ? /*#__PURE__*/ React.createElement(_CheckCircleFilled['default'], null)
  ...
  var classString = (0, _classnames['default'])(
    ...
    (0, _defineProperty2['default'])(
      ...
      ''
        .concat(prefixCls, '-')
        .concat((type === 'dashboard' && 'circle') || (steps && 'steps') || type),
      true,
    ),
    (0, _defineProperty2['default'])(
      _classNames,
      ''.concat(prefixCls, '-status-').concat(progressStatus),
      true,
    ),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-show-info'), showInfo),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-').concat(size), size),
    (0, _defineProperty2['default'])(
      _classNames,
