...
export declare const RadioOptionTypeContext: React.Context<
  import('./interface').RadioGroupOptionType | null
>;
export declare const RadioOptionTypeContextProvider: React.Provider<
  import('./interface').RadioGroupOptionType | null
>;
