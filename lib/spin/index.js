...
var Spin = function Spin(props) {
  ...
  var renderSpin = function renderSpin(_ref) {
    ...
    var spinClassName = (0, _classnames['default'])(
      ...
      (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-spinning'), spinning),
      (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-show-text'), !!tip),
    ...
    if (isNestedPattern()) {
      var containerClassName = (0, _classnames['default'])(
        ...
        (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-blur'), spinning),
      );
      return /*#__PURE__*/ React.createElement(
        'div',
        (0, _extends2['default'])({}, divProps, {
