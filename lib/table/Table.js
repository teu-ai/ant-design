...
function InternalTable(props, ref) {
  ...
  var needResponsive = React.useMemo(
    function () {
  ...
  var tableLocale = (0, _extends2['default'])(
    (0, _extends2['default'])({}, contextLocale.Table),
    locale,
  );
  ...
  var triggerOnChange = function triggerOnChange(info, action) {
    ...
    var changeInfo = (0, _extends2['default'])(
      (0, _extends2['default'])({}, changeEventInfo),
      info,
    );
    if (reset) {
    ...
    onChange === null || onChange === void 0
      ...
      : onChange(changeInfo.pagination, changeInfo.filters, changeInfo.sorter, {
          currentDataSource: (0, _useFilter3.getFilterData)(
            (0, _useSorter3.getSortData)(rawData, changeInfo.sorterStates, childrenColumnName),
  ...
  // ============================ Column ============================
  var columnTitleProps = React.useMemo(
    function () {
      var mergedFilters = {};
  ...
  var onPaginationChange = function onPaginationChange(current, pageSize) {
    triggerOnChange(
      {
        pagination: (0, _extends2['default'])(
          (0, _extends2['default'])({}, changeEventInfo.pagination),
          {
            current: current,
            pageSize: pageSize,
          },
  ...
  var _usePagination = (0, _usePagination3['default'])(
      mergedData.length,
      pagination,
      onPaginationChange,
    ),
  ...
  changeEventInfo.pagination =
    pagination === false
      ? {}
      : (0, _usePagination3.getPaginationParam)(pagination, mergedPagination);
      ...
      var _mergedPagination$cur = mergedPagination.current,
        ...
        pageSize =
          _mergedPagination$pag === void 0
            ? _usePagination3.DEFAULT_PAGE_SIZE
            : _mergedPagination$pag;
      process.env.NODE_ENV !== 'production'
        ? (0, _warning['default'])(current > 0, 'Table', '`current` should be positive number.')
        : void 0;
      // Dynamic table data
  ...
  mergedExpandable.expandIcon =
    mergedExpandable.expandIcon || expandIcon || (0, _ExpandIcon['default'])(tableLocale);
  ...
  // ============================ Render ============================
  var transformColumns = React.useCallback(
  ...
  if (
    ...
    var renderPagination = function renderPagination(position) {
      return /*#__PURE__*/ React.createElement(
        _pagination['default'],
        (0, _extends2['default'])({}, mergedPagination, {
          className: (0, _classnames['default'])(
            ''.concat(prefixCls, '-pagination ').concat(prefixCls, '-pagination-').concat(position),
  ...
  var wrapperClassNames = (0, _classnames['default'])(
    ...
    (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-wrapper-rtl'), direction === 'rtl'),
    className,
  );
  return /*#__PURE__*/ React.createElement(
    'div',
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        _rcTable['default'],
        (0, _extends2['default'])({}, tableProps, {
          ...
          emptyText:
            ...
            (renderEmpty || _defaultRenderEmpty['default'])('Table'),
          // Internal
