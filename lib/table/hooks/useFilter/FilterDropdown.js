...
function searchValueMatched(searchValue, text) {
  if (typeof text === 'string' || typeof text === 'number') {
    return text === null || text === void 0
      ? void 0
      : text.toString().toLowerCase().includes(searchValue.trim().toLowerCase());
  }
  return false;
}
...
function FilterDropdown(props) {
  ...
  var filtered = !!(
    filterState &&
    (((_a = filterState.filteredKeys) === null || _a === void 0 ? void 0 : _a.length) ||
  ...
  var triggerVisible = function triggerVisible(newVisible) {
    ...
    onFilterDropdownVisibleChange === null || onFilterDropdownVisibleChange === void 0
      ? void 0
  ...
  var propFilteredKeys =
    filterState === null || filterState === void 0 ? void 0 : filterState.filteredKeys;
  ...
  var onReset = function onReset() {
    ...
    if (filterResetToDefaultFilteredValue) {
      setFilteredKeysSync(
        (defaultFilteredValue || []).map(function (key) {
          return String(key);
        }),
      );
    } else {
  ...
  // ======================== Style ========================
  var dropdownMenuClass = (0, _classnames['default'])(
  ...
  var onCheckAll = function onCheckAll(e) {
    if (e.target.checked) {
      var allFilterKeys = (0, _.flattenKeys)(
    ...
    var getFilterComponent = function getFilterComponent() {
      ...
      if (filterMode === 'tree') {
        return /*#__PURE__*/ React.createElement(
          React.Fragment,
          null,
          /*#__PURE__*/ React.createElement(_FilterSearch['default'], {
            filterSearch: filterSearch,
            value: searchValue,
            onChange: onSearch,
              ...
              ? /*#__PURE__*/ React.createElement(
                  _checkbox['default'],
                  {
                    ...
                    indeterminate:
                      ...
                      selectedKeys.length < (0, _.flattenKeys)(column.filters).length,
  ...
  if (column.filterDropdown) {
    dropdownContent = /*#__PURE__*/ React.createElement(
      _OverrideContext.OverrideProvider,
      {
