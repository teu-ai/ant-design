...
function collectFilterStates(columns, init, pos) {
  ...
  (columns || []).forEach(function (column, index) {
    ...
    if ('children' in column) {
      filterStates = [].concat(
        (0, _toConsumableArray2['default'])(filterStates),
        (0, _toConsumableArray2['default'])(collectFilterStates(column.children, init, columnPos)),
      );
    }
  });
  return filterStates;
...
function flattenKeys(filters) {
  ...
  (filters || []).forEach(function (_ref2) {
    ...
    if (children) {
      keys = [].concat(
        (0, _toConsumableArray2['default'])(keys),
        (0, _toConsumableArray2['default'])(flattenKeys(children)),
      );
    }
  });
  return keys;
...
function useFilter(_ref4) {
  ...
  var mergedFilterStates = React.useMemo(
    function () {
