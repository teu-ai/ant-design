...
function getMultiplePriority(column) {
  if (
    (0, _typeof2['default'])(column.sorter) === 'object' &&
...
function collectSortStates(columns, init, pos) {
  ...
  (columns || []).forEach(function (column, index) {
    ...
    if (column.children) {
      ...
      sortStates = [].concat(
        (0, _toConsumableArray2['default'])(sortStates),
        (0, _toConsumableArray2['default'])(collectSortStates(column.children, init, columnPos)),
      );
  ...
  return (columns || []).map(function (column, index) {
    ...
    if (newColumn.sorter) {
      ...
      var upNode =
        ...
        /*#__PURE__*/ React.createElement(_CaretUpOutlined['default'], {
      ...
      var downNode =
        ...
        /*#__PURE__*/ React.createElement(_CaretDownOutlined['default'], {
      ...
      var tooltipProps =
        (0, _typeof2['default'])(showSorterTooltip) === 'object'
          ? showSorterTooltip
          : {
              title: sortTip,
            };
      newColumn = (0, _extends3['default'])((0, _extends3['default'])({}, newColumn), {
        className: (0, _classnames['default'])(
          newColumn.className,
          (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-column-sort'), sorterOrder),
        ),
        title: function title(renderProps) {
          var renderSortTitle = /*#__PURE__*/ React.createElement(
            'div',
            {
          ...
          return showSorterTooltip
            ? /*#__PURE__*/ React.createElement(
                _tooltip['default'],
                (0, _extends3['default'])({}, tooltipProps),
                renderSortTitle,
              )
            : renderSortTitle;
        },
        onHeaderCell: function onHeaderCell(col) {
          ...
          var displayTitle =
            renderTitle === null || renderTitle === void 0 ? void 0 : renderTitle.toString();
          ...
          cell.className = (0, _classnames['default'])(
            cell.className,
...
function generateSorterInfo(sorterStates) {
  ...
  if (list.length === 0 && sorterStates.length) {
    return (0, _extends3['default'])(
      (0, _extends3['default'])({}, stateToInfo(sorterStates[sorterStates.length - 1])),
      {
        column: undefined,
      },
    );
...
function useFilterSorter(_ref5) {
  ...
  var mergedSorterStates = React.useMemo(
    function () {
      var validate = true;
      ...
      function patchStates(state) {
        if (validate) {
          ...
          validateStates.push(
            (0, _extends3['default'])((0, _extends3['default'])({}, state), {
              sortOrder: null,
            }),
          );
        }
  ...
  var columnTitleSorterProps = React.useMemo(
    function () {
