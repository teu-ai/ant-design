...
var Timeline = function Timeline(props) {
  ...
  var classString = (0, _classnames['default'])(
    prefixCls,
    ((_classNames = {}),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-pending'), !!pending),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-reverse'), !!reverse),
    (0, _defineProperty2['default'])(
      _classNames,
      ''.concat(prefixCls, '-').concat(mode),
      !!mode && !hasLabelItem,
    ),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-label'), hasLabelItem),
    (0, _defineProperty2['default'])(
      _classNames,
