...
var TimelineItem = function TimelineItem(_a) {
  ...
  var itemClassName = (0, _classnames['default'])(
    ...
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-item-pending'), pending),
    _classNames),
    className,
  );
  var dotClassName = (0, _classnames['default'])(
    ((_classNames2 = {}),
    (0, _defineProperty2['default'])(_classNames2, ''.concat(prefixCls, '-item-head'), true),
