...
var Tooltip = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var onPopupAlign = function onPopupAlign(domNode, align) {
    ...
    var placement = Object.keys(placements).find(function (key) {
      var _a, _b;
      return (
        placements[key].points[0] ===
          ((_a = align.points) === null || _a === void 0 ? void 0 : _a[0]) &&
        placements[key].points[1] ===
          ((_b = align.points) === null || _b === void 0 ? void 0 : _b[1])
      );
    });
    if (!placement) {
      return;
  ...
  var child = getDisabledCompatibleChildren(
    (0, _reactNode.isValidElement)(children) && !(0, _reactNode.isFragment)(children)
      ? children
  ...
  var childCls =
    !childProps.className || typeof childProps.className === 'string'
      ...
      : childProps.className;
  var customOverlayClassName = (0, _classnames['default'])(
    overlayClassName,
    ((_classNames2 = {}),
    (0, _defineProperty2['default'])(
      _classNames2,
  ...
  if (color && !PresetColorRegex.test(color)) {
    formattedOverlayInnerStyle = (0, _extends2['default'])(
      (0, _extends2['default'])({}, overlayInnerStyle),
      {
        background: color,
      },
    );
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    (0, _extends2['default'])({}, otherProps, {
      ...
      motion: {
        motionName: (0, _motion.getTransitionName)(
          rootPrefixCls,
          'zoom-big-fast',
