  ...
  function Transfer(props) {
    ...
    _this.getLocale = function (transferLocale, renderEmpty) {
      ...
      return (0, _extends2['default'])(
        (0, _extends2['default'])((0, _extends2['default'])({}, transferLocale), {
      ...
      _this.setStateKeys(direction, function (prevKeys) {
        ...
        if (checkAll) {
          ...
          mergedCheckedKeys = Array.from(
            new Set(
              [].concat(
                (0, _toConsumableArray2['default'])(prevKeys),
    ...
    _this.onItemSelect = function (direction, selectedKey, checked) {
      ...
      var holder =
        direction === 'left'
          ? (0, _toConsumableArray2['default'])(sourceSelectedKeys)
          : (0, _toConsumableArray2['default'])(targetSelectedKeys);
    ...
    [
      {
        ...
        value: function getTitles(transferLocale) {
          var _a, _b;
          return (_b =
            (_a = this.props.titles) !== null && _a !== void 0 ? _a : transferLocale.titles) !==
            null && _b !== void 0
            ? _b
            : [];
        },
            ...
            function (contextLocale) {
              return /*#__PURE__*/ React.createElement(
                ...
                function (_ref3) {
                  ...
                  return /*#__PURE__*/ React.createElement(
                    _context.FormItemInputContext.Consumer,
                    null,
                    function (_ref4) {
                      var _classNames;
                      ...
                      var _this2$props = _this2.props,
                        ...
                        showSearch =
                          _this2$props$showSear === void 0 ? false : _this2$props$showSear,
                      ...
                      var locale = _this2.getLocale(
                        contextLocale,
                        renderEmpty || _defaultRenderEmpty['default'],
                      );
                      var _this2$state = _this2.state,
                        sourceSelectedKeys = _this2$state.sourceSelectedKeys,
                        targetSelectedKeys = _this2$state.targetSelectedKeys;
                      var mergedStatus = (0, _statusUtils.getMergedStatus)(
                        contextStatus,
                        customStatus,
                      );
                      ...
                      return /*#__PURE__*/ React.createElement(
                        ...
                        /*#__PURE__*/ React.createElement(_operation['default'], {
