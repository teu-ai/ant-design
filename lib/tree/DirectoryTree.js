...
function getIcon(props) {
  ...
  return expanded
    ? /*#__PURE__*/ React.createElement(_FolderOpenOutlined['default'], null)
    : /*#__PURE__*/ React.createElement(_FolderOutlined['default'], null);
}
...
var DirectoryTree = function DirectoryTree(_a, ref) {
  ...
  var getInitExpandedKeys = function getInitExpandedKeys() {
    ...
    if (defaultExpandAll) {
      ...
      initExpandedKeys = (0, _util.conductExpandParent)(
  ...
  var onSelect = function onSelect(keys, event) {
    ...
    var ctrlPick =
      (nativeEvent === null || nativeEvent === void 0 ? void 0 : nativeEvent.ctrlKey) ||
      (nativeEvent === null || nativeEvent === void 0 ? void 0 : nativeEvent.metaKey);
    ...
    if (multiple && ctrlPick) {
      ...
      newEvent.selectedNodes = (0, _dictUtil.convertDirectoryKeysToNodes)(
        treeData,
        newSelectedKeys,
      );
