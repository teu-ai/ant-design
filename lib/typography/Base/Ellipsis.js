...
var Ellipsis = function Ellipsis(_ref) {
  ...
  var nodeList = React.useMemo(
    function () {
      return (0, _toArray['default'])(text);
    },
    [text],
  );
  var totalLen = React.useMemo(
    function () {
      return getNodesLen(nodeList);
    },
    [nodeList],
  );
  var mergedChildren = React.useMemo(
    function () {
  ...
  (0, _useLayoutEffect['default'])(
    function () {
      ...
      if (walkingState === PREPARE) {
        setSingleRowHeight(
          ((_a = singleRowRef.current) === null || _a === void 0 ? void 0 : _a.offsetHeight) || 0,
        );
      }
    },
    [walkingState],
    ...
    function () {
      ...
      if (singleRowHeight) {
        if (walkingState === PREPARE) {
          ...
          var midHeight =
            ((_a = midRowRef.current) === null || _a === void 0 ? void 0 : _a.offsetHeight) || 0;
          ...
          if (startLen !== endLen) {
            var _midHeight =
              ((_b = midRowRef.current) === null || _b === void 0 ? void 0 : _b.offsetHeight) || 0;
