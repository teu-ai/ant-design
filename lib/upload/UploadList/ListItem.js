...
var ListItem = /*#__PURE__*/ React.forwardRef(function (_ref, ref) {
  ...
  if (listType === 'picture' || listType === 'picture-card') {
    if (mergedStatus === 'uploading' || (!file.thumbUrl && !file.url)) {
      var _classNames;
      var uploadingClassName = (0, _classnames['default'])(
        ((_classNames = {}),
      ...
      var thumbnail = (isImgUrl === null || isImgUrl === void 0 ? void 0 : isImgUrl(file))
        ...
        : iconNode;
      var aClassName = (0, _classnames['default'])(
        ((_classNames2 = {}),
        (0, _defineProperty2['default'])(
          _classNames2,
          ''.concat(prefixCls, '-list-item-thumbnail'),
  ...
  var infoUploadingClass = (0, _classnames['default'])(
    ((_classNames3 = {}),
    (0, _defineProperty2['default'])(_classNames3, ''.concat(prefixCls, '-list-item'), true),
    (0, _defineProperty2['default'])(
      _classNames3,
      ''.concat(prefixCls, '-list-item-').concat(mergedStatus),
      true,
    ),
    (0, _defineProperty2['default'])(
      _classNames3,
    ...
    showDownloadIcon && mergedStatus === 'done'
      ? actionIconRender(
          (typeof customDownloadIcon === 'function'
            ...
            : customDownloadIcon) ||
            /*#__PURE__*/ React.createElement(_DownloadOutlined['default'], null),
          function () {
  ...
  var previewIcon = showPreviewIcon
    ? /*#__PURE__*/ React.createElement(
        ...
        typeof customPreviewIcon === 'function'
          ...
          : customPreviewIcon || /*#__PURE__*/ React.createElement(_EyeOutlined['default'], null),
      )
    : null;
  var actions =
    listType === 'picture-card' &&
        ...
        function (_ref2) {
          ...
          var loadingProgress =
            'percent' in file
              ? /*#__PURE__*/ React.createElement(
                  _progress['default'],
                  (0, _extends2['default'])({}, progressProps, {
                    type: 'line',
          ...
          return /*#__PURE__*/ React.createElement(
            'div',
            {
              className: (0, _classnames['default'])(
                ''.concat(prefixCls, '-list-item-progress'),
                motionClassName,
              ),
            },
            loadingProgress,
  ...
  var listContainerNameClass = (0, _classnames['default'])(
