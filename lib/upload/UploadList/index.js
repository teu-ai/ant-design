...
var InternalUploadList = function InternalUploadList(props, ref) {
  ...
  var internalIconRender = function internalIconRender(file) {
    ...
    var fileIcon =
      isImgUrl && isImgUrl(file)
        ? /*#__PURE__*/ React.createElement(_PictureTwoTone['default'], null)
        : /*#__PURE__*/ React.createElement(_FileTwoTone['default'], null);
    var icon = isLoading
      ? /*#__PURE__*/ React.createElement(_LoadingOutlined['default'], null)
      : /*#__PURE__*/ React.createElement(_PaperClipOutlined['default'], null);
    if (listType === 'picture') {
      icon = isLoading
        ? /*#__PURE__*/ React.createElement(_LoadingOutlined['default'], null)
        : fileIcon;
  ...
  var actionIconRender = function actionIconRender(customIcon, callback, prefixCls, title) {
    ...
    if ((0, _reactNode.isValidElement)(customIcon)) {
      var btnIcon = (0, _reactNode.cloneElement)(
        customIcon,
        (0, _extends2['default'])((0, _extends2['default'])({}, customIcon.props), {
  ...
  var listClassNames = (0, _classnames['default'])(
    ((_classNames = {}),
    (0, _defineProperty2['default'])(_classNames, ''.concat(prefixCls, '-list'), true),
  ...
  // >>> Motion config
  var motionKeyList = (0, _toConsumableArray2['default'])(
          ...
          return (0, _reactNode.cloneElement)(appendAction, function (oriProps) {
            return {
              ...
              style: (0, _extends2['default'])(
                (0, _extends2['default'])((0, _extends2['default'])({}, motionStyle), {
